(function (f) {
  ...
  function z(a, b) {
    ...
    for (
      ...
      e < g && !((c = a.body[e][b].toString().length), c > d && (d = c), 40 < d);
      e++
    );
    return 5 < d ? d : 5;
  }
  function v(a) {
    n === o &&
      (n =
        -1 === w.serializeToString(f.parseXML(p["xl/worksheets/sheet1.xml"])).indexOf("xmlns:r"));
        ...
        var d = b.newline ? b.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n",
          ...
          j = function (a) {
            for (var b = "", c = 0, d = a.length; c < d; c++)
              0 < c && (b += g), (b += e ? e + ("" + a[c]).replace(f, h + e) + e : a[c]);
            return b;
          },
  ...
  i.ext.buttons.excelFlash = f.extend({}, t, {
    ...
    action: function (a, b, d, c) {
      var a = c._flash,
        ...
        i = function (a) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            ...
            "number" === typeof a[b] ||
            (a[b].match && f.trim(a[b]).match(/^-?\d+(\.\d+)?$/) && !f.trim(a[b]).match(/^0\d+/))
              ? (d = l(g, "c", { attr: { t: "n", r: d }, children: [l(g, "v", { text: a[b] })] }))
              : ((i = !a[b].replace
                  ? a[b]
                  : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")),
                (d = l(g, "c", {
                  attr: { t: "inlineStr", r: d },
                  children: { row: l(g, "is", { children: { row: l(g, "t", { text: i }) } }) },
                })));
            k.appendChild(d);
          }
          h.appendChild(k);
      ...
      for (n = b.header.length; m < n; m++)
        i.appendChild(
          l(g, "col", { attr: { min: m + 1, max: m + 1, width: z(b, m), customWidth: 1 } })
        );
