                    ...
                    }
                    {
                        ...
                        (
                            <View style={styles.group}>
                                ...
                                <TouchableOpacity style={styles.content_box} onPress={()=>NavigationService.navigate('RegisterForRegistration',{carIndex:carIndex,Id:data.id,license:data.license_plates})}>
