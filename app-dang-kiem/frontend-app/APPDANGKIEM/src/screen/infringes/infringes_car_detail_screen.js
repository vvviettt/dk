...
const InfringesCarDetailScreen = ({navigation,route}) => {
    ...
    return (
        <View style={{flex:1}}>
            <Header onGoBack={()=>navigation.goBack()} title={'Danh sách lỗi vi phạm'}/>
            {
                isLoading == true ?
                (
                    <Loading />
...
export default InfringesCarDetailScreen
